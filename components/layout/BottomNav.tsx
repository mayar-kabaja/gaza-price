...
function NavIcon({
  ...
  const base = "w-6 h-6 shrink-0 transition-colors";
...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 inset-x-0 w-full bg-surface border-t border-border flex z-40 md:hidden"
        ...
        {NAV_ITEMS.map(({ href, icon, label }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "flex-1 flex flex-col items-center justify-center gap-1 py-2.5 pt-3 pb-4 min-w-0 transition-colors hover:text-olive/80",
            ...
            >
              ...
              <span
                className={cn(
                  "text-[10px] font-body truncate w-full text-center px-0.5",
