...
/** GET /api/gp-ctrl/logs/snapshots — Price snapshots. Requires admin JWT. */
export async function GET(req: NextRequest) {
  ...
  searchParams.get("product_id") && params.set("product_id", searchParams.get("product_id")!);
  ...
  try {
    const res = await fetch(`${base}/gp-ctrl/logs/snapshots?${params}`, {
