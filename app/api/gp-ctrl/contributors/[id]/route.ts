...
/** DELETE /api/gp-ctrl/contributors/[id] — Remove contributor and all their data. Requires admin JWT. */
export async function DELETE(
  ...
  try {
    const res = await fetch(`${base}/gp-ctrl/contributors/${id}`, {
      method: "DELETE",
...
/** PATCH /api/gp-ctrl/contributors/[id] — Update contributor (display_handle, area_id, trust_level, is_banned). Requires admin JWT. */
