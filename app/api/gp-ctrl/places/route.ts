...
/** GET /api/gp-ctrl/places — List places. Requires admin JWT. */
export async function GET(req: NextRequest) {
  ...
  try {
    const res = await fetch(`${base}/gp-ctrl/places?${params}`, {
...
/** POST /api/gp-ctrl/places — Create a place. Requires admin JWT. */
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${base}/gp-ctrl/places`, {
      method: "POST",
