                  ...
                  <tr key={a.id} className="border-b border-[#243040] hover:bg-[#18212C]">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex gap-2 flex-wrap">
                        <button onClick={() => openEditModal(a)} className="text-[11px] text-[#8FA3B8] hover:text-[#D8E4F0] hover:underline">Edit</button>
                        <button onClick={() => setDeleteTarget(a)} className="text-[11px] text-[#E05A4E] hover:text-red-400 hover:underline">Remove</button>
                      </div>
                    </td>
                  </tr>
                ))}
