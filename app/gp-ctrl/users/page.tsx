...
export default function AdminUsersPage() {
  ...
  function load(overrideOffset?: number) {
    ...
    fetch(`/api/gp-ctrl/contributors?${params}`, {
  ...
  async function confirmAddSubmit() {
    ...
    try {
      const res = await fetch("/api/gp-ctrl/contributors", {
        method: "POST",
  ...
  async function confirmEditSubmit() {
    ...
    try {
      const res = await fetch(`/api/gp-ctrl/contributors/${editingContributor.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
        body: JSON.stringify(payload),
      });
  ...
  async function confirmBan() {
    ...
    try {
      const res = await fetch(`/api/gp-ctrl/contributors/${banTarget.id}/ban`, {
        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function confirmUnban() {
    ...
    try {
      const res = await fetch(`/api/gp-ctrl/contributors/${unbanTarget.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function confirmRemove() {
    ...
    try {
      const res = await fetch(`/api/gp-ctrl/contributors/${removeTarget.id}/ban`, {
        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function handleStatusChange(c: Contributor, ban: boolean) {
    ...
    try {
      if (ban) {
        const res = await fetch(`/api/gp-ctrl/contributors/${c.id}/ban`, {
          method: "POST",
          headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
        ...
        const res = await fetch(`/api/gp-ctrl/contributors/${c.id}`, {
          method: "PATCH",
          headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
          body: JSON.stringify({ is_banned: false, ban_reason: null }),
        });
