...
export default function AdminReportsPage() {
  ...
  function load() {
    ...
    fetch(`/api/gp-ctrl/reports?${params}`, {
  ...
  async function confirmApprove() {
    ...
    try {
      const res = await fetch(`/api/gp-ctrl/prices/${approveTarget.id}/status`, {
        method: "PATCH",
  ...
  async function confirmUnapprove() {
    ...
    setActionLoading(true);
    try {
      const res = await fetch(`/api/gp-ctrl/prices/${unapproveTarget.id}/status`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function confirmRemove() {
    ...
    setActionLoading(true);
    try {
      const res = await fetch(`/api/gp-ctrl/prices/${removeTarget.id}/status`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function handleEditSubmit() {
    ...
    setEditSaving(true);
    try {
      const res = await fetch(`/api/gp-ctrl/prices/${editTarget.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
        body: JSON.stringify({
  ...
  async function handleStatusChange(r: Report, newStatus: string) {
    ...
    try {
      const res = await fetch(`/api/gp-ctrl/prices/${r.id}/status`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
